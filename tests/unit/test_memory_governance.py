...
from memoria.core.memory.tabular.governance import GovernanceScheduler, GovernanceCycleResult
...
class TestVectorIndexHealth:
    ...
    def _patch_vm(self, scheduler, vm):
        ...
        ), patch("memoria.core.memory.tabular.governance.VectorManager", return_value=vm)
